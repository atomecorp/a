...
| Closed | IDENTITY_ALIAS | auth bootstrap / Home / directory.public | account creation and projection | Le telephone pouvait alimenter username puis name. | Identite publique fausse et fuite du login. | Contrats auth/Home/directory 2026-08-30 | Username technique opaque, aucun fallback de nom, publication sans nom refusee. |
