...
export interface InitOutput {
  ...
  readonly __wasm_bindgen_func_elem_4933: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_4690: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_103945: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_103929: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_4934: (a: number, b: number, c: number) => void;
  readonly __wasm_bindgen_func_elem_4932: (a: number, b: number) => void;
  readonly __wasm_bindgen_func_elem_4936: (a: number, b: number, c: number, d: number) => void;
