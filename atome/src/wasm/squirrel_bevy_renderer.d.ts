...
export function apply_atome_bevy_video_track(track: any): void;
...
export function remove_atome_bevy_video_track(id: string): void;
...
export function update_atome_bevy_video_transform(id: string, transform: any): void;
...
export interface InitOutput {
  ...
  readonly apply_atome_bevy_surface_background: (a: any) => [number, number];
  readonly apply_atome_bevy_text_metadata: (a: any) => [number, number];
  readonly apply_atome_bevy_transform: (a: any) => [number, number];
  readonly apply_atome_bevy_video_track: (a: any) => [number, number];
  ...
  readonly read_atome_bevy_video_backend_capabilities: () => [number, number, number];
  readonly read_atome_bevy_video_copy_diagnostics: () => [number, number, number];
  readonly read_atome_bevy_web_diagnostics: () => [number, number, number];
  readonly remove_atome_bevy_video_track: (a: number, b: number) => [number, number];
  ...
  readonly update_atome_bevy_video_transform: (a: number, b: number, c: any) => [number, number];
