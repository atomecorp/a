...
export function apply_atome_bevy_ui_ops(ops: any): void;

export function apply_atome_bevy_visibility(patch: any): void;

export function drain_atome_bevy_ui_events(): any;
...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_8947: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_65894: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_127563: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_141519: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_9162: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_9161: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_65955: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_127568: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_141534: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_9160: (a: number, b: number) => void;
