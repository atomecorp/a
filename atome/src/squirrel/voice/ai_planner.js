...
const buildPlannerPrompt = ({
    ...
    const rules = english
        ? [
            ...
            'Use the PROJECT_SCENE section to know the current project, authenticated user, selected atomes, and recent mutations or errors. When the user asks about the project, the scene, what is selected, or what was just done, answer using PROJECT_SCENE data.',
        ...
        : [
            ...
            'Utilise la section PROJECT_SCENE pour connaître le projet courant, l\'utilisateur authentifié, les atomes sélectionnés, et les mutations ou erreurs récentes. Quand l\'utilisateur pose une question sur le projet, la scène, ce qui est sélectionné ou ce qui vient d\'être fait, réponds à partir de PROJECT_SCENE.',
