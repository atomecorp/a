...
function getOptionalMessagesApi() {
...
function normalizeCommunicationSourceItem(item = {}, surface = 'mail') {
...
async function listCommunicationItems(params = {}) {
...
async function searchCommunicationItems(params = {}) {
...
async function readCommunicationItem(params = {}) {
