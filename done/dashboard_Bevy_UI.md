...
- [x] **T2.1** Inventaire exhaustif des records dashboard : lister depuis `dashboard_records.js` chaque kind de
      ...
      `todo/ui_bevy/dashboard_bevy_ui_parity_matrix.md`. Tout champ sans équivalent Bevy UI = ligne « À implémenter ».
