...
- Seeded a default anonymous project with a welcome message; the default content lives in `eVe/default_data/default_project.js`.
...
- eVe/tools/project_bootstrap.js
- eVe/tools/user.js
