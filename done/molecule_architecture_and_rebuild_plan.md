...
1. [DONE] Creer un module `project_store` (`eVe/core/project_store/`).
2. [DONE] Creer un module `event_store` (`eVe/core/event_store/`).
3. [DONE] Creer un module `media_store` (`eVe/core/media_store/`).
...
1. [DONE] Creer le dossier `eVe/intuition/tools/molecule` (sous-dossier `kernel/`).
