...
- `eVe/domains/media/api/audio_api.js` envoie actuellement le payload vers `window.__toDSP()` sous forme de chaîne JSON.
...
- dans `eVe/domains/media/api/audio_api.js`
...
- `eVe/tests/fixtures/audio/impulse_1s_48k_mono.wav`
- `eVe/tests/fixtures/audio/click_track_120bpm_48k_mono.wav`
- `eVe/tests/fixtures/audio/sine_440_5s_48k_mono.wav`
- `eVe/tests/fixtures/audio/voice_ref_16k_mono.wav`
- `eVe/tests/fixtures/audio/stereo_pan_lr_48k.wav`
...
- `eVe/tests/audio/analyze_wav_alignment.mjs`
- `eVe/tests/audio/build_audio_fixtures.mjs`
- `eVe/tests/audio/assert_wav_props.mjs`
- `eVe/tests/audio/run_native_audio_matrix.mjs`
...
- `eVe/tests/audio/analyze_wav_alignment.mjs`
- `eVe/tests/audio/run_tauri_audio_playback_probe.mjs`
- `eVe/tests/audio/run_tauri_audio_record_probe.mjs`
- `eVe/tests/audio/run_tauri_audio_sync_probe.mjs`
- `eVe/tests/audio/run_web_audio_capture_probe.mjs`
- `eVe/tests/audio/fixtures/audio/README.md`
