...
- Snapshot restore through the newer state snapshot path replays restore as events (`database/adole.js:1737-1761`; `database/adole.snapshot_restore_invariants.probe.mjs:7-75`).
...
| --- | --- | --- | --- | ---: | --- | --- | --- |
| T01 | History | Repair particle history helpers to use real schema columns (`new_value`, `changed_at`) and preserve compatibility aliasing. | Done | 2h | None | `node --test database/adole.event_projection_invariants.probe.mjs database/adole.snapshot_restore_invariants.probe.mjs database/adole.particle_history_invariants.probe.mjs` passed: 3/3. | 2026-06-12 |
| T02 | History | Add an event replay contract test proving `state_current` can be rebuilt from `events` for create, set, delete, and restore flows. | Done | 4h | T01 | `node --test database/adole.event_projection_invariants.probe.mjs database/adole.snapshot_restore_invariants.probe.mjs database/adole.particle_history_invariants.probe.mjs tests/database/adole_event_replay_rebuild.probe.mjs database/adole.sanitization.probe.mjs` passed: 7/7. | 2026-06-12 |
| T03 | History | Convert or quarantine legacy `createSnapshot` / `restoreSnapshot` so active Atome restore cannot bypass append-only events. | Done | 6h | T02 | `node --test tests/database/adole_legacy_snapshot_event_restore.probe.mjs database/adole.snapshot_restore_invariants.probe.mjs tests/database/adole_event_replay_rebuild.probe.mjs database/adole.event_projection_invariants.probe.mjs database/adole.particle_history_invariants.probe.mjs database/adole.sanitization.probe.mjs` passed: 8/8. `node --check database/adole.js tests/database/adole_legacy_snapshot_event_restore.probe.mjs` passed. | 2026-06-12 |
| T04 | History | Define durable `HistoryTransaction` semantics around `tx_id`, including undo-visible events and redo persistence rules. | Done | 8h | T02 | `node --test tests/database/adole_history_transactions.probe.mjs tests/database/adole_event_replay_rebuild.probe.mjs tests/database/adole_legacy_snapshot_event_restore.probe.mjs database/adole.snapshot_restore_invariants.probe.mjs database/adole.event_projection_invariants.probe.mjs database/adole.particle_history_invariants.probe.mjs database/adole.sanitization.probe.mjs` passed: 13/13. `node --check database/adole.js database/adole_history_transactions.js tests/database/adole_history_transactions.probe.mjs tests/database/adole_event_replay_rebuild.probe.mjs tests/database/adole_legacy_snapshot_event_restore.probe.mjs` passed. | 2026-06-12 |
| T05 | History | Add restart-safe undo/redo tests for text edit, drag, resize, and rename using event log reconstruction. | Done | 8h | T04, T21 | Added `tests/database/adole_restart_safe_interactions.probe.mjs` proving restart reconstruction preserves text edit, drag, resize, and semantic rename state from append-only events, and that undo/redo transaction grouping survives event-log reload. Fixed ADOLE projection to clone incoming event patches before projection enrichment so immutable semantic rename events can persist safely. `node --test tests/database/adole_restart_safe_interactions.probe.mjs tests/database/adole_event_replay_rebuild.probe.mjs tests/database/adole_history_transactions.probe.mjs tests/shared/semantic_rename_contract.probe.mjs database/adole.event_projection_invariants.probe.mjs database/adole.snapshot_restore_invariants.probe.mjs database/adole.particle_history_invariants.probe.mjs database/adole.sanitization.probe.mjs` passed: 17/17. `node --check` passed for touched DB/test files. | 2026-06-12 |
| T06 | AtomGraph | Create a pure `AtomGraph` builder from state rows/events with roots, parent-child links, visual order, and deletion filtering. | Done | 6h | T02 | `node --test tests/shared/atom_graph.probe.mjs` passed: 4/4. `node --check atome/src/shared/atom_graph.js`, `node --check atome/shared/atom_graph.js`, and `node --check tests/shared/atom_graph.probe.mjs` passed. | 2026-06-12 |
| T07 | AtomGraph | Add graph invariant tests for cycles, orphans, duplicate ids, stable child order, and deleted-node reachability. | Done | 5h | T06 | `node --test tests/shared/atom_graph.probe.mjs` passed: 8/8. `node --check atome/src/shared/atom_graph.js` and `node --check tests/shared/atom_graph.probe.mjs` passed. | 2026-06-12 |
| T08 | AtomGraph | Extend the graph contract with separate visual order, semantic reading order, and focus order fields. | Done | 6h | T06, T07 | `node --test tests/shared/atom_graph.probe.mjs` passed: 9/9. `node --check atome/src/shared/atom_graph.js` and `node --check tests/shared/atom_graph.probe.mjs` passed. | 2026-06-12 |
...
| T10 | Accessibility | Define `AccessibleAtomNode` schema and sanitizer for role, label, description, alt text, focusable state, actions, and relations. | Done | 6h | T08 | `node --test tests/shared/accessible_atom_node.probe.mjs` passed: 4/4. `node --check atome/src/shared/accessible_atom_node.js`, `node --check atome/shared/accessible_atom_node.js`, and `node --check tests/shared/accessible_atom_node.probe.mjs` passed. | 2026-06-12 |
| T11 | Accessibility | Build `AccessibilityGraph` derivation from `AtomGraph` and Atome properties without reading visible DOM. | Done | 8h | T10 | `node --test tests/shared/accessibility_graph.probe.mjs` passed: 5/5. `node --check atome/src/shared/accessibility_graph.js`, `node --check atome/shared/accessibility_graph.js`, and `node --check tests/shared/accessibility_graph.probe.mjs` passed. | 2026-06-12 |
| T12 | Accessibility | Add a browser/WebView accessibility bridge contract as a disposable semantic projection, not a visual source of truth. | Done | 8h | T11 | `node --test tests/shared/accessibility_bridge_contract.probe.mjs` passed: 3/3. `node --check atome/src/shared/accessibility_bridge_contract.js`, `node --check atome/shared/accessibility_bridge_contract.js`, and `node --check tests/shared/accessibility_bridge_contract.probe.mjs` passed. | 2026-06-12 |
| T13 | Accessibility | Add accessibility behavior tests for reading order, focus order, accessible actions, label update, and focus restoration. | Done | 8h | T12, T21 | Added `tests/shared/accessibility_behavior_contract.probe.mjs`, proving AccessibilityGraph reading/focus order, AccessibilityBridgeProjection action mirroring, SemanticRename label updates, and InlineEditSession focus restoration without DOM-owned state or forced pointer paths. `node --test tests/shared/accessibility_behavior_contract.probe.mjs tests/shared/accessibility_graph.probe.mjs tests/shared/accessibility_bridge_contract.probe.mjs tests/shared/semantic_rename_contract.probe.mjs tests/shared/core_atome_types.probe.mjs` passed: 18/18. `node --check tests/shared/accessibility_behavior_contract.probe.mjs` passed. | 2026-06-12 |
...
| T15 | Type Registry | Populate core Atome type definitions for text, shape, image, video, audio, waveform, group, project, and tool instance. | Done | 6h | T06 | `node --test tests/shared/core_atome_types.probe.mjs` passed: 5/5. `node --check atome/src/shared/core_atome_types.js`, `node --check atome/shared/core_atome_types.js`, and `node --check tests/shared/core_atome_types.probe.mjs` passed. Existing renderer behavior unchanged: no renderer imports or dispatch changes. | 2026-06-12 |
...
| T18 | Type Registry | Update maps and tests for strict type schemas and renderer adapter ownership. | Done | 4h | T17 | Maps now document core strict type schemas plus renderer adapter ownership in `CODEMAP`, `API_MAP`, and `ARCHITECTURE_MAP`. Targeted validations passed: `node --test tests/shared/core_atome_types.probe.mjs` passed 5/5 and `npm run test:run -- tests/eve/bevy_projection_adapter_contract.test.mjs` passed 7/7. Static review confirmed map references for `core_atome_types`, `renderer_adapter_registry`, `bevy_renderer_adapter_registry`, and `bevy_projection_adapter_contract`. | 2026-06-12 |
