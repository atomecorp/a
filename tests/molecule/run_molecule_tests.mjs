...
const SUITES = [
    ...
    'tests/probes/molecule_session_durability_atomicity.test.mjs',
    'tests/probes/molecule_snapshot_invariants.test.mjs',
    'tests/probes/molecule_mutation_property.test.mjs',
    'tests/probes/molecule_ui_mcp_parity.test.mjs',
    'tests/probes/molecule_audio_capture_adapter.test.mjs',
    'tests/probes/molecule_recording_session.test.mjs',
    'tests/probes/molecule_recording_runtime.test.mjs',
    'tests/probes/molecule_generic_recording.test.mjs',
    'tests/probes/molecule_contextual_creation.test.mjs',
    'tests/probes/molecule_record_scheduler.test.mjs',
    'tests/probes/molecule_transport_runtime.test.mjs',
    'tests/probes/molecule_stores.test.mjs',
    'tests/probes/molecule_v2_structure.test.mjs',
    'tests/probes/molecule_list_projection.test.mjs',
    'tests/probes/molecule_mix_projection.test.mjs',
    'tests/probes/molecule_timeline_activity.test.mjs',
