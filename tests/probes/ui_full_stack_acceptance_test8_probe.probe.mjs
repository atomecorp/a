  ...
  steps.push(
    {
      ...
      file: 'tests/probes/audio_recording_bevy_capture_probe.probe.mjs',
    ...
    },
    {
      ...
      file: 'tests/probes/atome_persistence_probe.probe.mjs',
    ...
    },
    {
      ...
      file: 'tests/probes/media_fixture_import_playback_probe.probe.mjs',
