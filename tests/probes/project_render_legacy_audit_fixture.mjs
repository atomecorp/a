...
export const communicationSource = await readSource('eVe/intuition/tools/communication_share_resolve.js');
export const timelineSource = await readSource('eVe/core/atome_timeline_replay.js');
