...
- `src/application/eVe/domains/mtrax/preview/`
...
- La sauvegarde de timeline dans `src/application/eVe/domains/mtrax/timeline/persist_runtime.js` réécrit ensuite le payload du groupe avec `group_type: "media"`.
...
- [fait] Ajout de `src/application/eVe/domains/mtrax/tests/timeline_persist_runtime.test.mjs`.
- [fait] `node src/application/eVe/domains/mtrax/tests/timeline_persist_runtime.test.mjs`: PASS.
- [fait] `node src/application/eVe/domains/mtrax/tests/mtrack_commit_bridge_runtime.test.mjs`: PASS.
- [fait] `node src/application/eVe/core/media_engine/molecule.test.mjs`: PASS.
- [fait] `node src/application/eVe/domains/mtrax/tests/clip_deletion_runtime.test.mjs`: PASS.
- [fait] `node src/application/eVe/domains/mtrax/tests/join_playback_runtime.test.mjs`: PASS.
- [bloqué] Le test `src/application/eVe/domains/mtrax/preview/preview_host_resolution_runtime.test.mjs` mentionné dans l'IDE n'existe pas dans le workspace actuel.
...
- `src/application/eVe/domains/mtrax/tests/clip_loop_model.test.mjs` échouait avant correction: `buildClipPlaybackSegments` retournait `[]` dans le scénario de lecture aplatie d'une boucle/crop.
...
- [fait] `node src/application/eVe/domains/mtrax/tests/clip_loop_model.test.mjs`: PASS.
- [fait] `node src/application/eVe/domains/mtrax/tests/timeline_persist_runtime.test.mjs`: PASS.
- [fait] `node src/application/eVe/domains/mtrax/tests/mtrack_commit_bridge_runtime.test.mjs`: PASS.
- [fait] `node src/application/eVe/domains/mtrax/tests/clip_deletion_runtime.test.mjs`: PASS.
- [fait] `node src/application/eVe/domains/mtrax/tests/join_playback_runtime.test.mjs`: PASS.
...
- [confirmé] Le runtime MTrack/Molécule reste organisé autour d'un gros état singleton dans `src/application/eVe/domains/mtrax/core/state_factory.js`. Il mélange session, timeline, preview, rendu, audio, recording, sélection, drag, diagnostics et état projet.
...
- [fait] Toute la suite locale `src/application/eVe/domains/mtrax/tests/*.mjs`: PASS.
