...
- Project video atomes use `eVe/intuition/shared/media_video_poster_runtime.js` to render and persist an image poster over the video surface, preventing black live-video rectangles on the desktop after recording.
