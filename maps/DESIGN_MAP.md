...
- Every visible instance of that backdrop material is live: resizing the surface updates its logical sampling space, and moving or resizing project content underneath Flower, the contextual side rail, or the bottom menu must refresh the complete capture/blur/presentation chain. A stale captured object or white band is a blocking visual defect; this contract is met with bounded redraw primes only while backdrop materials exist, not with continuous idle rendering.
