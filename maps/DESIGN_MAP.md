...
- Owns the dashboard v1 visual token contract for Bevy projection records: colors, radius default, header side-shadow style, layers, dimensions, header/plus/card metrics, fullscreen editor padding, and the `300ms` fullscreen transition duration.
