...
- Owns the dashboard v1 visual token contract for Bevy projection records and scene effects: colors, radius default, project veil, violet reserved-band fill, dormant backdrop blur radius/downsample/tint, bottom shadow gradient, header side-shadow style, layers, dimensions, header/plus/card metrics, and fullscreen item detail padding. Fullscreen item detail opens immediately on disposable Bevy records; it does not animate a white expansion panel.
