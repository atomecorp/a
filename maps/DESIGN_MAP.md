...
- Post-session dashboard display reuses the existing dashboard Bevy records and the existing main ribbon visual contract through `user_workspace_surface_runtime.js`; it does not add login-specific dashboard DOM, CSS, tokens, or alternate menu visuals.
