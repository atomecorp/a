...
- `eVe/domains/dashboard/` owns the closed eVe dashboard runtime: JSON default loading, category/item normalization, pure layout, visual tokens, transition interpolation, R&D mockup-style Bevy record projection, data adapters, environment resize/handedness observation, and main Atom handle toggle lifecycle.
