...
- `eVe/domains/media/shared/media_playback_audio_executor.js` is the single Kira execution owner shared by standalone, Ensemble and Molecule adapters. It owns unlock, source/extracted-video-audio preparation, asset load, voice start/stop and cleanup; `molecule.native.js` now delegates its PlayRecordCore adapter to this executor instead of maintaining a second implementation.
