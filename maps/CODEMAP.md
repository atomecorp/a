...
- `eVe/domains/dashboard/dashboard_environment.js` owns dashboard shell/environment reads: current project resolution, toolbox reserved height, handedness preference, and active-category item projection for render layout. It does not own durable project state or DOM rendering.
