...
- `eVe/intuition/ribbon/bevy_ui_menu_surface.js` owns the shared Bevy corner-resize grip constructor and its `resize_corner.svg` asset; Atome-edit and panel footer trees consume it without local glyphs, insets, or duplicate corner visuals.
