...
- `platforms/desktop-tauri/src/bevy_backend/renderer.rs` owns the native Bevy App/window entry point. It builds native window settings and installs `atome_bevy_renderer_core::AtomeBevyRendererPlugin` instead of duplicating projection, spawn, or selection rendering.
