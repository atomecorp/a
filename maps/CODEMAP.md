...
- `eVe/intuition/runtime/eve_intuition/atome_contextual_edit_runtime.js` owns session-only multi-Atome editing state, active context, canonical footer drag/resize gestures, fullscreen geometry, handedness, rail scroll, vertical-slider sessions, and BevyUI lifecycle.
