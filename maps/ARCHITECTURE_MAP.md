...
- Dashboard acceptance is split between deterministic Node contracts for data/layout/mockup/record-geometry/data-adapter invariants and a real Playwright probe for main Atom handle toggling, canvas hit-testing, persistence, toolbox exclusion, fullscreen editor behavior, screenshot-visible entêtes/cards, logical-coordinate records, and handedness mirroring.
