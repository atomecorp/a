...
- Tauri desktop: local Axum, WebGPU, native Kira, native Symphonia, and optional feature-gated native Bevy wrapper that uses the shared Atome Bevy core instead of WASM or platform-local projection code.
