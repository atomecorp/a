...
The procedural material uses surface_parameters/surface_style for shared procedural data and dedicated mystic_tiles/mystic_tile_motion/mystic_tile_colors plus a capture epoch for the two faces. The retired petal mode is removed. Menu entries retain canonical command identities; JSON adds composition, slots and label keys, not a new public command API. Assistant dock controls reuse the existing assistant runtime. Acceptance: eVe/documentations/MYSTIC_VALIDATION_2026-09-20.md.
