...
an already-active selection request.
Product-surface
...
The shared text session exposes start/stop, select-all, explicit ranges, point-to-caret placement, drag-range extension, editor synchronization, and immutable snapshots; the layout exposes glyph lines, measured bounds, point-to-index lookup, caret rectangles, and line-clipped selection rectangles.
