...
- Dialog and panel factories: `createEveDialog`, `revealEveDialog`, panel chrome helpers, bounds helpers, fullscreen helpers with viewport resize tracking only while fullscreen is active, overflow indicators.
