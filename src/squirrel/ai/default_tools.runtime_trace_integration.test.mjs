...
import { installMockBrowserEnv } from '../../application/eVe/tests/strangler_v2/_env.mjs';
...
const { commandBusV2 } = await import('../../application/eVe/intuition/runtime/index.js');
