...
// Initialisation de l'affichage des paroles après création du DOM
setTimeout(() => {
    // Initialiser l'affichage des paroles
    lyricsDisplay = new LyricsDisplay('lyrics-container');
    
    // Créer et charger les paroles de démonstration
    const demoLyrics = createDarkboxLyrics();
    lyricsDisplay.loadLyrics(demoLyrics);
    
    console.log('🎵 Système de paroles synchronisées initialisé');
    console.log('🎵 Paroles disponibles:', SyncedLyrics.getAllStoredLyrics());
}, 100);
...
// Initialisation de la bibliothèque de paroles
