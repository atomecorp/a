 ...
 * Les plugins sont chargés globalement depuis app.js
 */

// Vérification que WaveSurfer et les plugins sont disponibles
if (typeof WaveSurfer === 'undefined') {
    console.error('❌ WaveSurfer not found! Make sure app.js loads WaveSurfer globally.');
    throw new Error('WaveSurfer not available globally');
}

if (typeof RegionsPlugin === 'undefined') {
    console.error('❌ WaveSurfer plugins not found! Check app.js plugin imports.');
    throw new Error('WaveSurfer plugins not available globally');
}

console.log('✅ WaveSurfer and all plugins are available globally!');
console.log('📦 Using:', { WaveSurfer, RegionsPlugin, TimelinePlugin, MinimapPlugin, ZoomPlugin, HoverPlugin });
