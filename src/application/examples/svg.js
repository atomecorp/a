...
// setTimeout(() => {
  ...
  dataFetcher('images/icons/copy.svg', 'my_nice_svg', 'view','433px', '99px', '120px', '120px' , 'green', 'red')
    .then(txt => { render_svg(txt); })

  // dataFetcher('images/icons/copy.svg', 'my_nice_svg', 'view','433px', '99px', '120px', '120px' , 'white', 'red')
  //   .then(svgData => { render_svg(svgData); })
...
// fetch_and_render_svg('images/icons/communication.svg', 'my_nice_svg', 'view','433px', '99px', '120px', '120px' , 'white', 'red');
