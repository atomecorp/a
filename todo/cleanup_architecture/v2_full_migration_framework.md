...
1. `eVe/intuition/eVeIntuition.js`
2. `eVe/intuition/matrix/core/matrix_runtime.js`
3. `eVe/intuition/tools/user.js`
4. `eVe/intuition/tools/infos.js`
5. `eVe/intuition/tools/communication.js`
6. `eVe/intuition/tools/activities.js`
7. `eVe/intuition/tools/mtrack.js`
8. `eVe/intuition/tools/core/tool_reveal_behavior.js`
9. `eVe/intuition/tools/perform.js`
10. `eVe/intuition/tools/capture.js`
11. `eVe/intuition/tools/debug.js`
12. `eVe/intuition/tools/project_drop.js`
13. `eVe/intuition/tools/core/tool_runtime.js`
14. `eVe/intuition/contracts/contracts.js`
15. `eVe/intuition/contracts/index.js`
...
[ ] Verifier que `eVe/intuition___prev` n est jamais importe en runtime.
...
Les commandes suivantes doivent retourner 0 occurrence dans `eVe/intuition` (hors `intuition_prev`):

1. `rg "eveGoeyMenuApi" eVe/intuition --glob '!eVe/intuition___prev/**'`
2. `rg "\\bnew_menu\\b|window\\.new_menu\\b" eVe/intuition --glob '!eVe/intuition___prev/**'`
3. `rg -P "_intuition_(?!v2_)" eVe/intuition --glob '!eVe/intuition___prev/**'`
4. `rg "TOOL_INSTANCE_CONTRACT_V1|TOOL_SKIN_CONTRACT_V1" eVe/intuition --glob '!eVe/intuition___prev/**'`
