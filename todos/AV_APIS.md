...
- `src/application/eVe/domains/media`
...
- `record_audio()` in `src/application/eVe/domains/media/api/audio_api.js`
...
- There is duplicated video recording logic in `src/application/examples/record_video.js` and `src/application/eVe/domains/media/api/video_api.js`.
