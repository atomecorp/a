...
- The footer contains the panel title, close control, and left/right resize grips.
...
- Footer contains title, close control, left resize grip, and right resize grip.
